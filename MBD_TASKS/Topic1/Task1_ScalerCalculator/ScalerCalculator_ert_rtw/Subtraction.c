...
/* Output and update for atomic system: '<Root>/Subtraction' */
void ScalerCalculator_Subtraction(real_T rtu_Num1, real_T rtu_Num2,
  B_Subtraction_ScalerCalculato_T *localB)
{
  /* Sum: '<S5>/Subtract' */
  localB->Subtract = rtu_Num1 - rtu_Num2;
}
